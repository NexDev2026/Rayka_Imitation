        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div class="lg:col-span-4 space-y-4">
                    ...
                    <div class="space-y-2.5 pt-1 text-xs">
                        <div class="flex items-start space-x-2.5 text-stone-300">
                            ...
                            <span class="leading-relaxed">Shop No. 29, Shreeji Bapa Complex, Near Rita Nagar Bus Stand, Vastral Road, Amraiwadi, Ahmedabad - 380026, Gujarat</span>
                        </div>

                        <div class="flex items-center flex-wrap gap-2 pt-1">
                            <a href="https://share.google/vaohJv28SH29hBV8j" target="_blank" rel="noopener noreferrer" 
                            ...
                            <a href="https://www.instagram.com/rayka_imitation_amdavad/?hl=en" target="_blank" rel="noopener noreferrer" 
                ...
                <div class="lg:col-span-3 space-y-4 text-xs">
                    ...
                    <div class="pt-1 text-xs">
                        ...
                        <div class="flex items-center flex-wrap gap-x-2.5 gap-y-1 text-[#E7C77B] font-medium">
                            <a href="tel:+918128498531" class="hover:underline flex items-center space-x-1">
                                ...
                                <span>+91 81284 98531</span>
                            </a>
                            <span class="text-stone-500">•</span>
                            <a href="tel:+919316453838" class="hover:underline flex items-center space-x-1">
                                <span>+91 93164 53838</span>
                            </a>
                        </div>
                    </div>
            ...
            <div class="pt-5 border-t border-[#D4AF6A]/15 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-stone-400">
                <p class="text-center sm:text-left text-[11px] sm:text-xs">
                    © {{ date('Y') }} <span class="text-[#E7C77B] font-medium">Rayka Imitation Jewellery</span>. All Rights Reserved. Crafted with Royal Pride in India.
                </p>
