@php
  ...
  $headerIcon = $isPaid
    ...
    : ($isCod 
        ...
        : '<svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#F59E0B" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" style="vertical-align:middle;display:inline-block;"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg>');
@endphp
...
@section('content')
  ...
  @else
    <!-- Pending Verification: Amber Luxury SaaS Status Card -->
    <div style="background:linear-gradient(135deg, #2b1f13 0%, #17100b 100%); border:1px solid #d97706; border-radius:18px; padding:22px 24px; margin-bottom:28px; box-shadow:0 12px 35px rgba(0,0,0,0.55);">
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td valign="top">
            <div style="display:inline-block; background:#d97706; color:#ffffff; font-size:10.5px; font-weight:800; letter-spacing:1px; text-transform:uppercase; padding:4px 12px; border-radius:20px; margin-bottom:10px;">
              ⏳ Payment Verification in Progress
            </div>
            <div style="font-size:13px; color:#94a3b8; margin-bottom:6px; font-weight:500;">
              Rayka Imitation Jewellery • Order #{{ $order->order_number }}
            </div>
            <div style="font-size:11px; color:#fde68a; text-transform:uppercase; letter-spacing:1px; margin-bottom:2px; font-weight:700;">
          ...
          <td align="right" valign="middle" style="width:65px;">
            <div style="width:54px; height:54px; background:#d97706; border-radius:50%; text-align:center; line-height:54px; display:inline-block; box-shadow:0 0 25px rgba(217, 119, 6, 0.45);">
              <span style="color:#ffffff; font-size:24px; font-weight:900; line-height:54px; display:block;">⏳</span>
            </div>
          </td>
        </tr>
      </table>
    ...
    <table class="detail-table">
      ...
      <tr>
        ...
        <td class="val">
          ...
          @else
            <span style="color:#F59E0B; font-weight:700; background:rgba(245,158,11,0.15); padding:2px 8px; border-radius:4px; border:1px solid #F59E0B;">⏳ Verification in Progress</span>
          @endif
        </td>
      </tr>
  ...
  @else
    <div class="alert-box" style="background:rgba(245,158,11,0.08); border-left:4px solid #f59e0b; color:#FAF7F0; padding:15px 18px; border-radius:8px; margin:22px 0;">
      <strong style="color:#f59e0b; font-size:13px; display:block; margin-bottom:4px;">⏳ Next Step — Admin Payment Verification:</strong>
      <span style="font-size:12.5px; color:#E2D9D0; line-height:1.6;">Our accounts concierge is currently verifying your submitted payment proof against our bank ledger. As soon as the payment is approved by admin, you will receive an official <strong>Payment Confirmation Email with your attached GST Tax Invoice</strong> and your jewellery will proceed to dispatch.</span>
    </div>
  @endif
