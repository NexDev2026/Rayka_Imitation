            ...
            <section class="space-y-4">
                ...
                <div class="pl-9 bg-[#FAF7F0] p-6 rounded-xl border border-[#D4AF6A]/30 flex flex-col md:flex-row md:items-center justify-between gap-4 mt-6">
                    ...
                    <div class="flex flex-col gap-2 shrink-0">
                        <a href="https://wa.me/918128498531" class="bg-[#2E180E] text-[#E7C77B] px-4 py-2 rounded-lg text-sm font-semibold flex items-center justify-center gap-2 hover:bg-[#3A1C0E] transition shadow-sm border border-[#D4AF6A]/30">
                        ...
                        <a href="mailto:care@raykajewellery.com" class="text-center text-xs text-stone-600 hover:text-[#996E2E] font-medium underline">
                            care@raykajewellery.com
                        </a>
                    </div>
                </div>
            </section>
